/*
 * SplitFlapText — split-flap departure-board style text animation.
 *
 * Adapted from React Bits (reactbits.dev / DavidHDev/react-bits),
 * MIT License: https://github.com/DavidHDev/react-bits
 *
 * Zero-dependency: plain React hooks + CSS animation + requestAnimationFrame.
 * Reduced-motion aware: settles on the first phrase and stops cycling.
 */
...
export const SplitFlapText = ({
	...
	flipsPerChar = 8,
	tileColor = "var(--flap-tile, #1c1e22)",
	textColor = "var(--flap-text, rgba(255,255,255,0.9))",
	tileRadius = 8,
	gap = 6,
	fontSize = 52,
	loop = true,
