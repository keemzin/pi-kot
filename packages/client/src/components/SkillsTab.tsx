 ...
 * toggles, diagnostics display, search filtering, and editing.
 */
...
export function SkillsTab({ onError }: Props) {
  ...
  return (
    <div style={{
      height: editingSkill ? "100%" : undefined,
      display: editingSkill ? "flex" : undefined,
      flexDirection: "column",
      minHeight: 0,
      overflow: editingSkill ? "hidden" : undefined,
    }}>
      {!editingSkill && (
          ...
          >
            <button
              ...
              style={{
                ...
                color: skill.source === "extension" ? "var(--text-dim)" : "var(--text-secondary)",
                cursor: skill.source === "extension" ? "not-allowed" : "pointer",
                fontWeight: 600,
